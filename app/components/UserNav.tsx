...
export const navItem = [{ name: 'Home', href: '/dashboard', icon: Home }, { name: 'Settings', href: '/dashboard/settings', icon: Settings }, { name: 'Billing', href: '/dashboard/billing', icon: CreditCard }]
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant={'ghost'} className="relative h-10 w-10 rounded-full">
          <Avatar className="h-10 w-10 rounf`">
            <AvatarImage src={image} alt="@shadcn" />
            <AvatarFallback>Mat</AvatarFallback>
          </Avatar>
        </Button>
      </DropdownMenuTrigger>
