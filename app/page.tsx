        ...
        <div className="max-w-3xl mx-auto text-center">
          <div>
            ...
            <p className="max-w-xl mx-auto mt-8 text-base lg:text-xl text-secondary-foreground">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis magnam rem dolores iste praesentium eligendi corrupti ab eveniet blanditiis quo. Obcaecati aperiam odit deleniti placeat amet vitae ipsum maxime ducimus?
            </p>
          </div>
